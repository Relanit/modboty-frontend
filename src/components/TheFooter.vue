    ...
    <footer>
        <div class="footer__contacts">
            ...
            <a href="https://twitch.tv/modboty" target="_blank">
                <svg width="25px" height="25px" viewBox="-0.5 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://discordapp.com/users/632210040245452811" target="_blank">
                <svg fill="#e3e3e3" width="25px" height="25px" viewBox="0 0 32 32">
                    <title>discord</title>
                    <path
            ...
            <a href="https://github.com/relanit" target="_blank">
                ...
                >
                    ...
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="Dribbble-Light-Preview" transform="translate(-140.000000, -7559.000000)" fill="#e3e3e3">
                            <g id="icons" transform="translate(56.000000, 160.000000)">
                                <path
        ...
        <p>© 2023 Relanit. Не связано с Twitch.</p>
    </footer>
</template>
